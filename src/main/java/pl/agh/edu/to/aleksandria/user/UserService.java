...
import pl.agh.edu.to.aleksandria.user.dtos.CreateUserRequest;
import pl.agh.edu.to.aleksandria.user.dtos.UpdateUserRequest;
...
public class UserService {
    ...
    public Optional<User> createUser(CreateUserRequest request) {
        ...
        // Register new one
        User newUser = new User(request.getFirstName(), request.getLastName(), request.getAddress(), request.getEmail(), userRole.get());
